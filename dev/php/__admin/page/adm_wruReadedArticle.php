...
class adm_wruReadedArticle extends admin_ctrl
{
    private $dataDefine;
    private $model;
    ...
    public function _construct()
    {
        ...
        $this->dataDefine = 'wruReadedArticle';
        $this->model = new ml_model_wruReadedArticle($this->dataDefine);
